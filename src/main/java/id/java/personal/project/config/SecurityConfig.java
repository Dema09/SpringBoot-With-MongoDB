...
import id.java.personal.project.security.jwt.AuthEntryPointJwt;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public SecurityConfig(boolean disableDefaults, UserDetailsServiceImpl userDetailsService, AuthEntryPointJwt unauthorizedHandler) {
